  ...
  state: {
    ...
    profile: {
      userData: {
        ...
        about: {
          title: "About Me",
          text: `<p>One of the greatest pleasures of my routine is to connect with people, whether to plan a sales action, put future campaigns on the agenda, analyze the results of past actions, or even focus on solutions to problems that arise along the way. The day-to-day of the International Education market is just like that, dynamic, and that's what I like the most!<br /><br />I hold a Bachelor's Degree in Tourism and I am currently taking a Post Degree Diploma in Business Administration at Langara College (Canada). During my academic career, I was able to be a member of the Junior Enterprise and a volunteer for AIESEC, one of the largest NGOs in the world.</p>
